...
# כולל את כל הענפים הזמינים ב-Pro Plan של The Odds API
SPORT_KEY_MAP = {
    # ── כדורגל (3-way) ──────────────────────────────────────────────────────
    ...
    # ── פוטבול אמריקאי (2-way) ──────────────────────────────────────────────
    "americanfootball_nfl":                     "american_football",
    "americanfootball_nfl_preseason":           "american_football",
    ...
    "tennis_wta_bad_homburg_open":              "tennis",
    # ── MMA / אגרוף (2-way) ──────────────────────────────────────────────────
